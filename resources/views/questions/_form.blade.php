@csrf
    ...
    <div class="form-group">
        <label for="question-body">Explain your question <small>(Include image only if necessary)</small></label>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-outline-primary btn-ms">{{ $buttonText }}</button>
    </div>
