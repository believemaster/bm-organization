...
<head>
    ...
    {{-- <title>{{ config('app.name', 'Ask & Suggest') }}</title> --}}
    <title>Ask N Suggest</title>

    <script src="https://kit.fontawesome.com/6a8c86cfe6.js" crossorigin="anonymous"></script>
